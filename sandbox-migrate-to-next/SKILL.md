...
description: Port a Cloudflare Sandbox app from stable @cloudflare/sandbox to the @next SDK 1.0 preview. Use only for migrations, not stable maintenance or new @next applications.
---
