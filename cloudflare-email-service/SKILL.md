...
description: Build or review Cloudflare Email Sending and Email Routing. Use for transactional email, Workers bindings, REST APIs, deliverability, SPF/DKIM/DMARC, or Agents SDK email.
---
