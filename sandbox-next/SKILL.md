---
name: sandbox-next
description: Build or change apps on @cloudflare/sandbox@next, the SDK 1.0 preview. Use for execution, runners, terminals, files, mounts, tunnels, lifecycle, or errors; not stable apps.
---
