---
name: agents-sdk
description: Build stateful AI agents on Cloudflare Workers. Use for Agents SDK state, RPC, WebSockets, schedules, workflows, queues, voice, MCP servers, or React chat clients.
---
