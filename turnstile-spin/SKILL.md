---
name: turnstile-spin
description: Set up Cloudflare Turnstile end to end. Use to add or fix CAPTCHA protection, create a widget, wire frontend and server-side siteverify, validate, and persist the skill.
references:
  - vanilla-html
  - nextjs-app
  - nextjs-pages
