---
name: sandbox-stable
description: Build or change apps on stable @cloudflare/sandbox. Use for commands, sessions, files, ports, tunnels, terminals, production, or deprecated-API cleanup; not the @next preview.
---
